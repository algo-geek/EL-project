            ...
            <div className='w-1/2 md:w-3/4 pl-7 flex-col'>
              <div className='justify-between flex'>
                <div className='flex flex-row mt-4'>
                  <div className='bg-grey rounded-full w-11 h-11'></div>
                  <div className='mt-3 ml-3'>
                    <span className='grey6'>abc abcdefrg</span>
                  </div>
                </div>
                <div className='rounded-full w-11 h-11 border border-grey mt-8 mr-3'></div>
              </div>
              ...
              <div className='mt-0'>
                <span className='text-lg font-medium'>XYZ Organisation</span>
              </div>
              <div className='mt-4'>
                <span className='text-base font-normal'>
                  XYZ Colony, xyz colony, xyz
                </span>
              </div>
              <div>
                <span className='text-base font-normal'>Assam, India</span>
              </div>
              ...
              <div className='mt-4 flex'>
                ...
                <span className='text-base font-normal ml-2'>+9188884685</span>
              </div>
            </div>
          </div>
        </div>

        <div className='lg:mr-20 mb-10 border border-black w-full lg:w-1/2 h-screen overflow-x-hidden'></div>
      </div>
    </>
  );
}
