    ...
    return (
        <>
            <nav className="flex flex-wrap bg-black p-6">
                ...
                <a className="flex items-center p-2 lg:ml-10 text-white cursor-pointer"
                    onClick={ToggleSidebar}
                >
            
                    <span>Assam, 784512, India</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="16" fill="#FFFF00" className="bi bi-chevron-down" viewBox="0 0 16 16">
            ...
            <div className={`sidebar fixed top-0 w-full sm:w-80 min-h-screen bg-white z-40 duration-500 mt-[11.7vh] 
            ...
            <div className={`bg-grey3 fixed top-0 left-0 w-full h-full 
